...
public abstract class PythonLexerBase extends Lexer {
    ...
    // A circular buffer where extra tokens are pushed on (see the NEWLINE and WS
    // lexer rules).
    ...
    private void emit(int tokenType, int channel, String text) {
        ...
        CommonToken token = new CommonToken(_tokenFactorySourcePair, tokenType, channel, charIndex - text.length(),
                charIndex - 1);
